...
export const SERVICES: Service[] = [
  {
    ...
    features: [
      ...
      { icon: "bolt", title: "ML Price Optimiser", desc: "Machine learning predicts optimal bid prices in real-time — maximising impression value while keeping CPMs efficient across every placement and format." },
  ...
  },
  {
    ...
    features: [
      { icon: "tv", title: "CTV & OEMs", desc: "Premium in-stream on Samsung TV Plus, LG Channels, Viu, meWatch, and 40+ CTV publishers across SEA. Full household targeting via IP graph." },
      { icon: "film", title: "OTT Premium", desc: "Non-skippable and skippable in-stream on leading OTT platforms. Content-adjacent targeting ensures brand-safe, contextually relevant environments." },
      { icon: "device-mobile", title: "Mobile Video", desc: "In-stream and out-stream on mobile web and in-app. Rewarded video available for gaming environments. MRAID + VPAID fully supported." },
      { icon: "scissors", title: "Creative Sequencing", desc: "30s awareness → 15s consideration → 6s decision. Sequential messaging that adapts creative to audience funnel stage across a single campaign." },
      { icon: "document", title: "VAST 4.0 Support", desc: "Full VAST 4.0 compliance including interactive overlays, companion ads, and cross-device measurement pixels." },
      { icon: "trending-up", title: "Completion Analytics", desc: "Quartile-level completion tracking (25%, 50%, 75%, 100%) with skip behaviour analysis and audience engagement scoring." },
    ],
    process: [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: "paint-brush", title: "DCO Integration", desc: "Dynamic Creative Optimisation — feeds, localisation, A/B variant testing, and weather/time triggers all built into the HTML5 layer." },
